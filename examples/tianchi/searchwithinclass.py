...
#gt = ['337000920288','337000938817','337000990895','337001021051','337000917948','337000944429','337001067462','337001081481','337001005787','337000922535','337000891656','337001051857','337000910506','337000997930','337001043870','337000906668','337000903495','337001052726','337001083714','337001086912','337001053949','337000912857']
batch_size=500
crop_num=1#5
batch=10000
query_imgname=[]
...
res=[[(10000.0,str(j)) for j in xrange(20)] for i in xrange(m)]
		...
		if key%batch == batch-1:
			...
			for j in xrange(m):
				...
				for l in xrange(crop_num):
					...
					for k in xrange(min(20,endp-startp)):
...
for i in range(m):			
	...
	for k in xrange(len(res[i])):
		...
		if tmp_re[1] not in names and (tmp_re[1][:2]==query_imgname[i][:2]):
